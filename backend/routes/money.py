...
class RequestsListOut(BaseModel):
    model_config = ConfigDict(extra="allow")
    incoming: List[RequestItemOut] = []
    outgoing: List[RequestItemOut] = []
...
@router.post("/money/request", response_model=RequestItemOut)
...
@router.post("/money/requests/{rid}/pay", response_model=AcceptTransferOut)
